...
class UserExamProgres(models.Model):
    """postup Uživatele aplikací celkově"""
    user = models.ForeignKey(User, on_delete=models.CASCADE)  # uživatel
    completed = models.IntegerField(blank=True, null=True, default=0)  # počet navštívených
    aviable = models.IntegerField(blank=True, null=True, default=0)  # počet dostupných
